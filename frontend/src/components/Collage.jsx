...
export const Collage = () => {
  return (
    <div className="relative flex flex-col items-center justify-start w-screen h-screen overflow-hidden bg-[#0A0B06]">
      ...
      <div className="absolute top-56 w-[830px] h-[614px] bg-[#B1FA63] flex-col rounded-[30px] border-8 border-[#142120] justify-center z-10">
        <span className="font-heading text-4xl mt-5 flex justify-center items-center p-7">
          What is medium crawler?
        </span>
        <div className="flex justify-center gap-5">
          <div className="w-[400px] h-[400px] bg-gray-400 rounded-[30px] flex justify-center items-center font-heading text-white">insert gif here</div>
