...
public class DataSeeder implements CommandLineRunner {
  ...
  private void seedUsers() {
    if (userRepository.count() == 0) {
      ...
      User john = new User(null, "John Doe", "john@example.com", passwordEncoder.encode("password123"), null);
      User jane = new User(null, "Jane Smith", "jane@example.com", passwordEncoder.encode("password456"), null);
      User alice = new User(null, "Alice Premium", "alice@example.com", passwordEncoder.encode("password789"),null);
